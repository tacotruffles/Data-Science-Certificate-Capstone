...
* Step 3: With this randomized sample of album data eadch `cover_image` was sent through three Google Vision APIs to: find how many faces, what color content, if there were any musical objects, and whether or not the cover is an abstract illustration or photograph.
